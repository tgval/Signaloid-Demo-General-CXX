...
```html
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-dark-v6.svg#gh-dark-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=[<your repository URL here>](https://github.com/tgval/Signaloid-Demo-General-CXX)#gh-dark-mode-only)
[<img src="https://assets.signaloid.io/add-to-signaloid-cloud-logo-light-v6.svg#gh-light-mode-only" alt="[Add to signaloid.io]" height="30">](https://signaloid.io/repositories?connect=[<your repository URL here>](https://github.com/tgval/Signaloid-Demo-General-CXX/)#gh-light-mode-only)
```
